...
const getImage = (obj, size) => {
  ...
  if (image && !image.startsWith('https://') && image.indexOf('tollbrothers.com') < 0 && image.indexOf('tollbrothers-static-public') < 0) {
...
const getWalkthroughURL = (walkthrough) => {
  ...
  if (walkthrough.type === 'walkthrough::matterport') {
    ...
    src = 'https://my.matterport.com/show/?m=' + walkthrough.link + '&ts=2&lp=1&hl=1&qs=1&search=0' + extraParams;
  } else {
